...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $numberVideos = $_POST['numberVideos'];
    ...
    $sql = "INSERT INTO course (slug, category, price, course_name, about_course, syllabus, duration, num_videos) 
            VALUES (:slug, :courseCategory, :coursePrice, :courseName, :aboutCourse, :syllabus, :courseDuration, :numberVideos )";
    ...
    $stmt->bindParam(':numberVideos', $numberVideos);
    $stmt->bindParam(':slug', $slug);
...
<body style="background-image: url(./images/headline-img.jpg)">
    ...
    <form method="post" class="form modal-hidden">
        ...
        <div class="form-group ">
            ...
            <input type="text" id="username" name="courseCategory" placeholder="Enter course category.." required>
            <span class="err">Error message</span>
        </div>
        <!-- Course Price -->
        <div class="form-group ">
            <label for="price">Course Price:</label>
            <input type="number" id="price" name="coursePrice" placeholder="Enter course price.." required>
            <span class="err">Error message</span>
        </div>
        <!-- Course Name -->
        <div class="form-group ">
            <label for="username">Course Name:</label>
            <input type="text" id="username" name="courseName" placeholder="Enter course name.." required>
            <span class="err">Error message</span>
        </div>
        <!-- Course Price -->
        <div class="form-group ">
            <label for="duration">Course Duration:</label>
            <input type="number" id="duree" name="courseDuration" placeholder="Enter duration.." required>
            <span class="err">Error message</span>
        </div>
        <!-- Course Price -->
        <div class="form-group ">
            <label for="videos">Course Videos:</label>
            <input type="number" id="videos" name="numberVideos" placeholder="Enter number of videos" required>
            <span class="err">Error message</span>
        </div>
        <!-- Course Description -->
        <div class="form-group ">
            <label for="description">About the Course:</label>
